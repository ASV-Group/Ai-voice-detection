...
//     initiateWebSocketAndStream();
//   };

//   const endCall = () => {
//     stopWebSocketAndStream();
//     setCallState("IDLE");
...
//   // WEBSOCKET & 1-SECOND CHUNK STREAMING ENGINE
//   const initiateWebSocketAndStream = async () => {
//     try {
...
//         // Update detection result from server
//         setResult({
...
//     } catch (err) {
//       console.error(err);
//       setError("Failed to initialize WebSocket stream.");
//       endCall();
//     }
//   };
...
//       // Capture slices every 1 second (1000ms)
//       const mediaRecorder = new MediaRecorder(stream, { mimeType: 'audio/webm' });
//       mediaRecorderRef.current = mediaRecorder;

//       mediaRecorder.ondataavailable = (e) => {
//         if (e.data.size > 0 && socketRef.current?.readyState === WebSocket.OPEN) {
//           // Stream raw 1-second audio chunk over WebSocket
//           socketRef.current.send(e.data);

//           secondCounterRef.current += 1;
//           setActiveChunkCount(secondCounterRef.current);

//           // Every 5 seconds, set processing indicator until socket responds
...
//       // Emit data every 1000ms (1 second)
...
//                   <label className="block text-[11px] font-medium text-slate-300 mb-1">Simulate Audio File</label>
//                   <input
//                     type="file"
//                     accept="audio/*"
...
//                   </div>
//                   <div>
//                     <h3 className="font-bold text-sm text-slate-100">Target Receiver</h3>
...
//                       <span>• Sec #{activeChunkCount}s</span>
//                     </div>
//                   )}
...
//                   Audio routes to Proxy before Receiver
//                 </div>
//               </div>
...
//                           <p className="text-[10px] text-blue-400">Evaluating 5-sec window...</p>
//                         </div>
//                       )}
...
//                         <p className="text-slate-500 text-[10px]">Listening to continuous 1s stream...</p>
//                       )}
